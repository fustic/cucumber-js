function ArgumentParser(argv) {
  ...
  var self = {
    ...
    getModularPartitioningOptions: function getModularPartitioningOptions() {
      var partSpecification = self.getOptionOrDefault(ArgumentParser.PART_OPTION_NAME, '').split('/');
      if (partSpecification.length !== 2) return null;
      return { 'parts': partSpecification[1], 'remainder': partSpecification[0] - 1 };
    },
    ...
    getKnownOptionDefinitions: function getKnownOptionDefinitions() {
      ...
      definitions[ArgumentParser.PART_OPTION_NAME]                 = String;
      ...
      definitions[ArgumentParser.FAIL_FAST_FLAG_NAME]              = Boolean;
      definitions[ArgumentParser.BACKTRACE_FLAG_NAME]              = Boolean;
      definitions[ArgumentParser.SOURCE_FLAG_NAME]                 = Boolean;
      definitions[ArgumentParser.COLORS_FLAG_NAME]                 = Boolean;
      return definitions;
    },
    ...
    getShortenedOptionDefinitions: function getShortenedOptionDefinitions() {
      ...
      definitions[ArgumentParser.TAGS_OPTION_SHORT_NAME]      = [ArgumentParser.LONG_OPTION_PREFIX + ArgumentParser.TAGS_OPTION_NAME];
      ...
      definitions[ArgumentParser.VERSION_FLAG_SHORT_NAME]     = [ArgumentParser.LONG_OPTION_PREFIX + ArgumentParser.VERSION_FLAG_NAME];
      definitions[ArgumentParser.NO_SNIPPETS_FLAG_SHORT_NAME] = [ArgumentParser.LONG_OPTION_PREFIX + 'no-' + ArgumentParser.SNIPPETS_FLAG_NAME];
      ...
      definitions[ArgumentParser.PART_OPTION_SHORT_NAME]      = [ArgumentParser.LONG_OPTION_PREFIX + ArgumentParser.PART_OPTION_NAME];
      return definitions;
    },

    isFailFastRequested: function isFailFastRequested() {
      return self.getOptionOrDefault(ArgumentParser.FAIL_FAST_FLAG_NAME, ArgumentParser.DEFAULT_FAIL_FAST_FLAG_VALUE);
    },
    ...
    shouldUseColors: function shouldUseColors () {
      return self.getOptionOrDefault(ArgumentParser.COLORS_FLAG_NAME, ArgumentParser.DEFAULT_COLORS_FLAG_VALUE);
    },
...
ArgumentParser.PROFILE_OPTION_SHORT_NAME                 = 'p';
ArgumentParser.PART_OPTION_NAME                          = 'part';
ArgumentParser.PART_OPTION_SHORT_NAME                    = 'w';
...
ArgumentParser.FAIL_FAST_FLAG_NAME                       = 'fail-fast';
...
ArgumentParser.DEFAULT_FAIL_FAST_FLAG_VALUE              = false;
ArgumentParser.VERSION_FLAG_NAME                         = 'version';
ArgumentParser.VERSION_FLAG_SHORT_NAME                   = 'v';
...
ArgumentParser.COLORS_FLAG_NAME                          = 'colors';
ArgumentParser.DEFAULT_COLORS_FLAG_VALUE                 = true;
ArgumentParser.SNIPPETS_FLAG_NAME                        = 'snippets';
ArgumentParser.NO_SNIPPETS_FLAG_SHORT_NAME               = 'i';
