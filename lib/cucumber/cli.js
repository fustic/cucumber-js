...
--part PARTNUMBER/COUNT       Split up the tests into COUNT parts and run\n\
                              the PARTNUMBER part. This can be used to break\n\
                              up the test suite into segments for the purpose\n\
                              of parallelization.\n\
\n\
                              PARTNUMBER is indexed starting from one, so e.g.\n\
                              cucumber.js -part 1/3\n\
                              runs the first of three parts of the test suite.\n\
\n\
